...
if ($id) {
    // Fetch Furniture record using PDO as per your original code
    $stmt = $pdo->prepare("SELECT * FROM furnitures WHERE id = ?");
    $stmt->execute([$id]);
...
<head>
    ...
    <title>Furniture_Slip_<?php echo htmlspecialchars($row['pr_no']); ?></title>
...
<div class="container no-print mb-3 text-center">
    ...
    <a href="../table.php?cat=furnitures" class="btn btn-dark btn-sm px-4">Exit</a>
</div>
...
<div class="slip-card">
    <div class="row align-items-end mb-4">
        <div class="col-8">
            ...
            <h2 class="slip-subtitle">Furniture Requisition & Tracking Slip</h2>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-4">
            ...
            <div class="value-text"><?php echo htmlspecialchars($row['payment_mode'] ?: 'N/A'); ?></div>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-3">
            ...
            <div class="value-text text-uppercase fw-bold"><?php echo htmlspecialchars($row['brand'] ?? 'N/A'); ?></div>
        </div>
        <div class="col-4">
            <div class="label-text">SUPPLIER</div>
            <div class="value-text text-uppercase"><?php echo htmlspecialchars($row['suppliers'] ?: 'N/A'); ?></div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="value-text" style="min-height: 2.5rem;"><?php echo nl2br(htmlspecialchars($row['specs'] ?: 'No detailed specifications recorded.')); ?></div>
        </div>
    </div>

    <div class="row mt-2">
        <div class="col-6">
            <div class="label-text">FURNITURE ITEM</div>
            <div class="value-text"><?php echo htmlspecialchars($row['items']); ?></div>
        </div>
        <div class="col-3 text-center">
            <div class="label-text">UNIT</div>
            <div class="value-text"><?php echo htmlspecialchars($row['unit'] ?? 'Units'); ?></div>
        </div>
        <div class="col-3 text-center">
    ...
    <table class="table-checklist">
        ...
        <tbody>
            <?php 
            // Maintaining your original checklist column mapping
            $checklist = [
                'PR' => 'pr', 
                'ABC' => 'abc', 
                'PPMP' => 'ppmp', 
