...
$query = "SELECT * FROM appliances WHERE id = ?";
...
<head>
    ...
    <title>Appliances_Slip_<?php echo htmlspecialchars($data['pr_no']); ?></title>
...
<div class="container no-print mb-3 text-center">
    ...
    <a href="../table.php?cat=appliances" class="btn btn-dark btn-sm px-4">Exit</a>
</div>
...
<div class="slip-card">
    <div class="row align-items-end mb-4">
        <div class="col-8">
            ...
            <h2 class="slip-subtitle">Appliances Requisition & Tracking Slip</h2>
        </div>
    ...
    <div class="row mt-2">
        <div class="col-6">
            <div class="label-text">APPLIANCE ITEM</div>
