...
$query = "SELECT * FROM heavy_equipment WHERE id = ?";
...
// Ensure costs are treated as floats to prevent number_format errors
...
<head>
    ...
    <title>Heavy_Equipment_Slip_<?php echo htmlspecialchars($data['pr_no']); ?></title>
...
<div class="container no-print mb-3 text-center">
    ...
    <a href="../table.php?cat=heavy_equipment" class="btn btn-dark btn-sm px-4">Exit</a>
</div>
...
<div class="slip-card">
    <div class="row align-items-end mb-4">
        <div class="col-8">
            ...
            <h2 class="slip-subtitle">Heavy Equipment Requisition & Tracking Slip</h2>
        </div>
    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="value-text" style="min-height: 3rem;"><?php echo nl2br(htmlspecialchars($data['specs'])); ?></div>
        </div>
    </div>

    <div class="row mt-2">
        <div class="col-6">
            <div class="label-text">EQUIPMENT ITEM</div>
    ...
    <table class="table-checklist">
        ...
        <tbody>
            ...
            $checklist = [
                ...
                'BI-DOCS' => ['status_pr', 'remarks_pr'] // Bidocs data check
            ];
