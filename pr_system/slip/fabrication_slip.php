...
$query = "SELECT * FROM fabrication_installation WHERE id = ?";
...
<head>
    ...
    <title>Fabrication_Slip_<?php echo htmlspecialchars($data['pr_no']); ?></title>
    ...
    <style>
        ...
        /* Boxed Tracking Numbers like the image */
...
<div class="container no-print mb-3 text-center">
    ...
    <a href="../table.php?cat=fabrication" class="btn btn-dark btn-sm px-4">Exit</a>
</div>
...
<div class="slip-card">
    <div class="row align-items-end mb-4">
        <div class="col-8">
            ...
            <h2 class="slip-subtitle">Fabrication & Installation Requisition & Tracking Slip</h2>
        </div>
    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="value-text"><?php echo nl2br(htmlspecialchars($data['specs'])); ?></div>
        </div>
    </div>

    <div class="row mt-2">
        <div class="col-6">
            <div class="label-text">SCOPE OF WORK / ITEM</div>
            <div class="value-text"><?php echo htmlspecialchars($data['item']); ?> (<?php echo htmlspecialchars($data['scope_of_work']); ?>)</div>
        </div>
        <div class="col-3 text-center">
            <div class="label-text">UNIT / TYPE</div>
    ...
    <table class="table-checklist">
        ...
        <tbody>
            ...
            $checklist = [
                ...
                'IAR/ARE' => ['status_iar_are', 'remarks_iar_are'], // Matching your DB structure
                ...
                'BI-DOCS' => ['status_pr', 'remarks_pr'] // Placeholder since no bi-docs data
            ];

            foreach($checklist as $label => $cols): 
                $status = strtoupper($data[$cols[0]] ?? 'PENDING');
                $statusColor = ($status == 'COMPLETE') ? '#198754' : '#dc3545';
            ?>
            <tr>
