...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // 3. Map Checklist Arrays (Index 0-8)
    $status      = $_POST['status'];      
    ...
    // 4. Prepared Statement - ADDED ONE MISSING ? (Now 36 total)
    $sql = "INSERT INTO heavy_equipment (
    ...
    if ($stmt) {
        // FIXED: Added one 's' at the end to make it 36 type definitions
        ...
        if ($stmt->execute()) {
            $_SESSION['msg'] = "Heavy Equipment Record Successfully Saved!";
    ...
    // Redirect back to heavy equipment form
