...
<head>
    ...
    <title>Fabrication & Installation - PDS</title>
...
<div class="main-content">
    <form action="process/save_fabrication_installation.php" method="POST">
        <input type="hidden" name="form_type" value="fabrication">
        <div class="container">
            ...
            <div class="row mb-4 align-items-center">
                <div class="col-md-6">
                    <h3 class="fw-bold m-0 text-uppercase">Fabrication & Installation</h3>
                    <p class="text-muted">Labor and materials procurement tracking.</p>
                </div>
                ...
                <div class="col-lg-4">
                    <div class="card card-premium">
                        <div class="card-header-dark d-flex justify-content-between align-items-center">
                            <h6 class="mb-0"><i class="bi bi-tools me-2"></i>Check List</h6>
                            <a href="fabrication_bidocs.php" class="btn btn-sm btn-outline-light" style="font-size: 0.7rem;">FABRICATION BIDOCS</a>
                        </div>
                        ...
                        <div class="card-footer bg-white p-3">
                            <button type="submit" class="btn btn-success w-100 fw-bold py-3 shadow-sm text-uppercase">
                                <i class="bi bi-save-fill me-2"></i>Save Fabrication Record
                            </button>
                        </div>
                    </div>
                </div>
...
<footer>
    <div class="container">
        <div class="row align-items-center">
            <div class="col-md-6">
                <span class="fw-bold text-uppercase">Procurement <span style="color: var(--admin-green);">Data System</span></span>
            </div>
            <div class="col-md-6 text-md-end">
