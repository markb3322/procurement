...
<head>
    ...
    <title>Fixtures Procurement - PDS</title>
...
<div class="main-content">
    <div class="container">
        ...
        <form action="process/save_fixtures.php" method="POST">
            <input type="hidden" name="form_type" value="fixtures">
            
            <div class="row mb-4 align-items-center">
                <div class="col-md-6">
                    <h3 class="fw-bold m-0">FIXTURES FORM</h3>
                    <p class="text-muted">Procurement tracking for office and building fixtures.</p>
                </div>
                    ...
                    <div class="card card-premium mb-4">
                        <div class="card-body p-4">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    <label class="small fw-bold text-success">Total Cost (Manual/Auto)</label>
                ...
                <div class="col-lg-4">
                    <div class="card card-premium">
                        <div class="card-header-dark d-flex justify-content-between align-items-center">
                            <h6 class="mb-0"><i class="bi bi-gear-fill me-2"></i>Check List</h6>
                            <a href="#" class="btn btn-sm btn-outline-light" style="font-size: 0.7rem;">BIDOCS FIXTURES</a>
                        </div>
                        <div class="card-body p-0">
                            <table class="table mb-0">
                                ...
                                <tbody>
                                    <?php 
                                    $check_list = ['PR', 'ABC', 'PPMP', 'ACT DES', 'IAR/ARE', 'PDRS', 'APP', 'LETTER REQUEST', 'MANUAL OBR'];
                                    foreach($check_list as $cl): ?>
                                    <tr>
                                        <td class="small fw-bold align-middle ps-3"><?php echo $cl; ?></td>
                                        <td width="90px">
                                            <select name="status[]" class="form-select form-select-sm status-box" onchange="updateRow(this)">
                                                <option value="Not Complete">NC</option>
                                                <option value="Complete">C</option>
                                            </select>
                                        </td>
                                        <td>
                                            <input type="text" name="doc_remarks[]" class="form-control form-control-sm remark-out" 
                        ...
                        <div class="card-footer bg-white p-3">
                            <button type="submit" class="btn btn-success w-100 fw-bold py-3 shadow-sm text-uppercase">
                                <i class="bi bi-save-fill me-2"></i>Save Fixture Record
                            </button>
                        </div>
                    </div>
                </div>
...
<script>
// --- Manual & Auto Cost Calculation Logic ---
...
function updateRow(select) {
    ...
    const remarkField = row.querySelector('.remark-out');
...
document.querySelectorAll('.status-box').forEach(s => s.classList.add('status-pending'));
</script>
